...
namespace HerbMagicWebApi.Controllers.ForTom
{
    ...
    /// 桌游區
    /// </summary>
    public class HospitalMaskController : ApiController
    {
        /// <summary>
        /// 獨立案件 資料庫拉開
        /// </summary>
        ...
        /// 對應資料庫的表格
        /// </summary>
        public string TableName = "HospitalMask";
        ...
        /// </summary>
        /// <returns></returns>
        [Route("api/v1/HospitalMaskSearch")]
        [HttpGet]
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(MainBoardGame))]
        [SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(Error))]
        public HttpResponseMessage Get()
        {
            var dtoResult = GovDataFactory.GovMaskInfoRepository.GetGovMaskInfoDtos("","","");
            return Request.CreateResponse(HttpStatusCode.OK, dtoResult);
        }
        ///// <summary>
        ///// 增加桌遊
        ///// </summary>
